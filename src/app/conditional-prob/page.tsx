    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white p-4 sm:p-8 selection:bg-emerald-500/30">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-3">
          <h1 className="text-5xl sm:text-6xl font-black tracking-tighter bg-gradient-to-br from-white via-white to-emerald-400 bg-clip-text text-transparent">Conditional Probability</h1>
